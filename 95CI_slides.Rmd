...
```{r CI fig2, echo = FALSE, message = FALSE, warning=FALSE, results='hold', fig.height=4, fig.align='center'}
sample_data %>%
  group_by(sample) %>%
  filter(sample == 12) %>%
  summarise(mean = mean(heights),
...
(we'll discuss a ton of odd statistical things this term, stay tuned)
...
- find another dataset using the "datasets" package, calculate CIs and bootstrapped CIs for a statistic of your choice
